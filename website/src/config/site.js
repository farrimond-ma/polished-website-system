...
export const SITE = {
  ...
  url: 'https://polished-insurance.com',
  phoneDisplay: '0330 056 8970',
  phoneHref: 'tel:03300568970',
...
export const CRM_URL = (import.meta.env.VITE_CRM_URL || 'https://crm.polished-insurance.com').replace(/\/$/, '');
