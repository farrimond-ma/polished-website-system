...
// Line icons (Feather-style) used on cover cards. Keyed by the `icon` field in data/covers.js.
const paths = {
  ...
  carpet: <><rect x="3" y="5" width="18" height="14" rx="1" /><path d="M3 9h18M3 15h18M1 7v2M1 15v2M23 7v2M23 15v2" /></>,
  key: <><circle cx="7.5" cy="15.5" r="5.5" /><path d="m21 2-9.6 9.6M15.5 7.5l3 3L22 7l-3-3" /></>,
  oven: <><rect x="3" y="2" width="18" height="20" rx="2" /><path d="M3 8h18M7 5h.01M11 5h.01" /><rect x="7" y="11" width="10" height="7" rx="1" /></>,
  spray: <><path d="M3 3h4v6H3zM7 5h3l2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9" /><path d="M15 4h.01M18 3h.01M18 6h.01M21 4h.01M21 8h.01" /></>,
